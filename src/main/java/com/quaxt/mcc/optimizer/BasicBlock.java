...
public record BasicBlock(int nodeId, List<InstructionIr> instructions,
                         ArrayList<Node> predecessors, ArrayList<Node> successors) implements Node {
    ...
    public String toString() {
        return "BasicBlock{" + "nodeId=" + nodeId + ", instructions=" + instructions + ", predecessors=" + stringifyNodes(predecessors) + ", successors=" +
                stringifyNodes(successors) + '}';
    }
}
