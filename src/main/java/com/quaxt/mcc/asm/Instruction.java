...
public sealed interface Instruction extends AbstractInstruction permits Binary, Call, CallIndirect, Cdq, Cmp, Comment, Cvt, JmpCC, Lea, Mov, MovZeroExtend, Movsx, Nullary, Pop, Push, SetCC, Test, Unary, Jump, LabelIr {
