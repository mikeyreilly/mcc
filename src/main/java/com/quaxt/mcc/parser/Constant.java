...
sealed public interface Constant<C extends Constant<C>> extends Exp, ValIr permits CharInit, ConstantExp, DoubleInit, FloatInit, IntInit, LongInit, ShortInit, UCharInit, UIntInit, ULongInit, UShortInit, Nullptr {
    long toLong();
