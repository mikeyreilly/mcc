...
.Ldebug_info0:                   #   Compilation Unit @ offset 0x0:
        ...
        .long   0x49             #     <a2>   DW_AT_decl_column : 5
                                 ...
                                 #     <a3>   DW_AT_type        : <0x49>
        .quad   .LFB0            #     <a7>   DW_AT_low_pc      : 0x401146
        .quad   .LFE0-.LFB0      #     <af>   DW_AT_high_pc     : 0xba
        .uleb128 0x1             #     <b7>   DW_AT_frame_base  : 1 byte block: 9c       (DW_OP_call_frame_cfa)
        .byte   0x9c


                                 #     <b9>   DW_AT_call_all_tail_calls: 1
        .long   0x11e            #     <b9>   DW_AT_sibling     : <0x11e>
        ...
        .long   0x49             #     <c2>   DW_AT_decl_line   : 4
                                 #     <c2>   DW_AT_decl_column : 14
                                 #     <c3>   DW_AT_type        : <0x49>
        .uleb128 0x2             #     <c7>   DW_AT_location    : 2 byte block: 91 4c    (DW_OP_fbreg: -52)
        .byte   0x91
        .sleb128 -52
	.uleb128 0x6             #  <2><ca>: Abbrev Number: 6 (DW_TAG_formal_parameter)
        ...
        .byte   0xc              #     <113>   DW_AT_decl_line   : 12
        .byte   0x15             #     <114>   DW_AT_decl_column : 21
        .long   0x85             #     <115>   DW_AT_type        : <0x85>
        .uleb128 0x2             #     <119>   DW_AT_location    : 2 byte block: 91 60   (DW_OP_fbreg: -32) (60 is hex of sleb -32)
        .byte   0x91
        .sleb128 -32
        .byte   0                #  <3><11c>: Abbrev Number: 0
