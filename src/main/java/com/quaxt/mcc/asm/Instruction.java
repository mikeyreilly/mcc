...
public sealed interface Instruction extends AbstractInstruction permits Binary, Call, CallIndirect, Cdq, Cmp, Comment, Cvtsi2sd, Cvttsd2si, JmpCC, Lea, Mov, MovZeroExtend, Movsx, Nullary, Pop, Push, SetCC, Test, Unary, Jump, LabelIr {
